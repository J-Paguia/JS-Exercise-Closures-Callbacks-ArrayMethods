...
function firstNamesAllCaps(runners) {
  const newArr = runners.map(function(runners) { return runners.first_name.toUpperCase()});
  return newArr;
  /* CODE HERE */
}
...
function tallyUpDonations(runners) {
  return runners.reduce(function (tally, currentValue) {
    return tally + currentValue.donation;
  }, 0)
  /* CODE HERE */
}
